...
echo "    • Platform:  /etc/saids/opencti/"
echo "    • Worker:    /etc/saids/opencti-worker/"
echo "    • Python:    /opt/python312/"
echo "    • Node.js:   /opt/nodejs/"
echo "    • Logs:      /var/log/opencti{,-worker}/"
